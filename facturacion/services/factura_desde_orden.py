...
def _ajustar_redondeo_iva(
    ...
    if iva_global != iva_objetivo:
        raise ValidationError(
            "El IVA de la OT no coincide con "
            "el IVA calculado sobre su base imponible global. "
            f"Calculado: ${iva_global} | "
            f"OT: ${iva_objetivo}. "
