...
class EmpresaEmisora(models.Model):
    ...
    def clean(self):
        ...
        if self.resolucion_agente_retencion:
            self.resolucion_agente_retencion = (
                self.resolucion_agente_retencion
                .strip()
            )
    ...
    def obtener_firma_vigente(self):
        """
        Devuelve la firma electrónica activa y vigente
        más reciente de esta empresa.

        Si la empresa no posee ninguna firma válida,
        devuelve None.
        """
